...
public class NilpotentLieAlgTest {
  ...
  public void multiply() {
    MalcevStructureConstants sc =
        new MalcevStructureConstants.Builder(3).add(0, 1, 2, Rational.Companion.getONE()).build();
    ArrayTuple<Rational> t1 = new ArrayTuple<>(RationalArrays.INSTANCE.base(3, 0));
    ArrayTuple<Rational> t2 = new ArrayTuple<>(RationalArrays.INSTANCE.base(3, 1));
